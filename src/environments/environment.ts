export const environment = {
  ...
  STRIPE_PUBLIC_KEY:
    'pk_test_51IwTvvIR19rXEZpRWoj9M4BGNy5nJ1GQOsXUZXHRD0PS3QGexQQSVNQR0vMB8jMoONQtO4RNQ30pC3N5BdgiGstB00shA8ejRI',
  SERVER_URL: 'https://server.theislamicnation.com/',
  CHAT_URL: 'wss://server.theislamicnation.com/ws/chat/',
  FrontEnd_URL: window.location.origin,
  LoginURL: 'https://accounts.theislamicnation.com/',
  JSON_URL:
    'https://raw.githubusercontent.com/jihadelsayed/TheIslamicNation/main/json/',
